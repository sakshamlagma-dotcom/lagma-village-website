    ...
    page.innerHTML = `
      <main class="chat-app" aria-label="TODO AI chat">
        <header class="chat-header">
          ...
          <div class="chat-header-actions"><span class="connection-status" id="connectionStatus"><i></i><span>Online</span></span><button class="chat-icon-button" id="themeButton" type="button" aria-label="Toggle theme">☾</button><button class="chat-profile" type="button" aria-label="Profile">TU</button></div>
        </header>
